<!-- Kept in sync with CLAUDE.md, which is the source of truth. -->
...
route lists, component lists and described behaviour match the code. This file mirrors `CLAUDE.md`; edit
`CLAUDE.md` first, then propagate here.
